...
- [x] `Read` [Wikipedia entry on activation functions](https://en.wikipedia.org/wiki/Activation_function)
- [x] `Read` Chapter 1 from [Perceptrons: An introduction to computational geometry](https://mitpress.mit.edu/books/perceptrons)
